...
import SekolahPage from './Halaman/6-sekolah/page';
// import SoonPage from './Halaman/7-soon/page';
import ThenoisePage from './Halaman/9-thenoise/page';
        ...
        <div className="relative z-10">
          <div className="container mx-auto px-3 py-6">
            <div className="mb-6">
              ...
              <div className="p-2 md:p-6 rounded-xl transition-all duration-300 border border-gray-800/30">
                <div className="flex flex-col md:flex-row items-center gap-2 md:gap-4">
                  <div className="w-full order-1 mb-3 md:mb-0 md:order-1 md:w-1/2">
                  ...
                  <div className="w-full md:w-1/2 space-y-2 order-2 md:order-2">
                    <div className="relative aspect-[20/9] overflow-hidden rounded-lg group border border-gray-700/30">
                      <img
...
{/* 
            ...
            <div className="text-center text-gray-500 text-xs sm:text-sm mt-8 mb-20">
  ...
  // Menghapus kondisi yang memblokir akses jika role tidak sesuai
